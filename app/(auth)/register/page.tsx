...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Heart, Sparkles, Home, User } from "lucide-react";
    ...
    >
      ...
      <div className="heart-container relative w-[400px] h-[400px] cursor-pointer">
        <div className="heart-image w-full h-full flex items-center justify-center">
          ...
          >
            <defs>
              <radialGradient id="heartGlowR" cx="50%" cy="40%" r="60%">
      ...
      <div className="mt-8 text-center max-w-md">
        ...
        <p className="text-[19px] leading-[1.5] text-[#5b4041]">
          Create your account and discover a new way to grow closer, one AI-powered activity at a time.
        </p>
      </div>
    </motion.div>
  );
...
/* ═══════════════════════════════════════════════════════════════
   RegisterForm — name/email/password + Google auth (popup + redirect)
   ═══════════════════════════════════════════════════════════════ */
      ...
      <div className="glass-card rounded-2xl p-6 md:p-8 flex flex-col gap-6 shadow-[0_20px_40px_-15px_rgba(232,39,75,0.05)] border border-white/80">
        ...
        <div className="text-center mb-2">
          ...
          <p className="text-sm md:text-base text-[#5b4041]">
            Join Heart2Heart and start your journey together.
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-5">
          ...
          <div className="w-full">
            <label htmlFor="name" className="text-[13px] font-medium text-[#5b4041] mb-1.5 block ml-1 tracking-[0.05em]">
              Full Name
            </label>
            <div className="relative flex items-center group w-full">
              <User size={20} className="absolute left-4 text-[rgba(91,64,65,0.5)] group-focus-within:text-brand-rose transition-colors" />
              <input
                id="name"
                type="text"
                value={name}
          ...
          {/* Password */}
          <div className="w-full">
            <label htmlFor="password" className="text-[13px] font-medium text-[#5b4041] mb-1.5 block ml-1 tracking-[0.05em]">
              Password
            </label>
            <div className="relative flex items-center group w-full">
